...
pesos.costo
```
Si solo consideramos el Costo como criterio para la elección de la mejor alternativa, los resultados obtenidos para la elección de la mejor alternativa son: A5(0.3291) > A3(0.3158) > A2(0.1817) > A1(0.1084) > A4(0.0646).
...
pesos.ROI
```
Si solo consideramos el ROI como criterio para la elección de la mejor alternativa, los resultados obtenidos para la elección de la mejor alternativa son: A3(0.4382) > A1(0.2577) > A4(0.1603) > A2(0.0973) > A5(0.0463).
...
pesos.duracion
```
Si solo consideramos la Duración como criterio para la elección de la mejor alternativa, los resultados obtenidos para la elección de la mejor alternativa son: A2(0.4137) > A1(0.2412) > A3(0.1353) = A5(0.1353) > A4(0.0743).
...
pesos.segmentacion
```
Si solo consideramos la Segmentación como criterio para la elección de la mejor alternativa, los resultados obtenidos para la elección de la mejor alternativa son: A4(0.4382) > A1(0.2577) > A3(0.1603) > A2(0.0973) > A5(0.0463).
...
```
Hablando en porcentajes, la alternativa con mayor ponderador global es A3 (26.10), es decir, Email Marketing. En consecuencia, podemos considerar esta alternativa como la más preferida en función de los criterios que hemos considerado. 
En segundo lugar se encuentra la alternativa 1 (24.92), en tercer lugar la alternativa 4 (19.82) y en cuarto lugar la alternativa 5 (17.45).
En último lugar se encuentra A2 (11.70), es decir, Marketing de Contenidos. En consecuencia, podemos decir que esta alternativa es la menos preferida en función de los criterios que hemos considerado.
...
<u>**CONCLUSIÓN**</u>: La alternativa A3 es la mejor opción, con una prioridad del 40.6%. Además, tiene un nivel de inconsistencia bajo de 1.1%, lo que indica que las comparaciones realizadas entre las alternativas son consistentes y sin contradicciones significativas. En contraste, la alternativa A4 tiene la menor prioridad, con solo 16.0%, pero su inconsistencia también es baja, alcanzando un 1.8%. A pesar de su baja inconsistencia, A4 es la alternativa menos preferida.
